...
class Skin_Two extends Skin_Base
{
    ...
    public function section_style_dropdown(Widget_Base $widget)
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'sa-el-advanced-menu-dropdown-animate-zoom-in',
                'condition' => [
                    'skin_two_sa_el_advanced_menu_layout' => ['horizontal'],
                ],
                'separator' => 'after',
            ]
        );
    ...
    public function render()
    {
        ...
        $menu_classes = ['sa-el-advanced-menu', $settings['skin_two_sa_el_advanced_menu_dropdown_animation'], 'sa-el-advanced-menu-indicator'];
        $container_classes = ['sa-el-advanced-menu-container', $settings['skin_two_sa_el_advanced_menu_item_alignment'], $settings['skin_two_sa_el_advanced_menu_dropdown_item_alignment']];

        if ($settings['skin_two_sa_el_advanced_menu_layout'] == 'horizontal') {
            $menu_classes[] = 'sa-el-advanced-menu-horizontal';
        } else {
            $menu_classes[] = 'sa-el-advanced-menu-vertical';
        }

        if (isset($settings['skin_two_sa_el_advanced_menu_item_dropdown_indicator']) && $settings['skin_two_sa_el_advanced_menu_item_dropdown_indicator'] == 'yes') {
        ...
        $this->parent->add_render_attribute('sa-el-advanced-menu', [
            ...
            'data-indicator-class' => $settings['skin_two_sa_el_advanced_menu_item_indicator'],
            'data-dropdown-indicator-class' => $settings['skin_two_sa_el_advanced_menu_dropdown_item_indicator'],
        ]);
