                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p class="sa-el-msg">Import this Design via one click</p>
                            <div class="sa-el-btn-body">
                                <span class="sa-el-loader"></span>
                                <a href="javascript:void(0)" class="el-import-btn sael-btn sa-el-final-import-start">Import Design</a>
                                <a href="#" target="_blank" data-hr="<?php echo admin_url('post.php?post=') ?>" class="el-edit-btn sael-btn sa-el-final-edit-start" target="_blank">Edit Design</a>
                            </div>
                            <p class="sa-el-horizontal">OR</p>
                            <div class="sa-el-page-create">
                                <p>Create a new page from this Design</p>
